...
const { getAllUsers, getUser, createUser, updateUser, deleteUser, createUserProfile, getAllRoles, getUsersBySearchQuery, getUserByUsernameEmail, seedData, resetData } = require('../controllers/userController')
...
router.route('/reset').get(authenticateUser, authAdminUser, resetData)
